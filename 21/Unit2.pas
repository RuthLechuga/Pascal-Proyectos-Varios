  ...
  for i:=1 to 102 do
   ...
   begin
     if b3 = true then
      ...
      if valor2>= 10 then
           valor2:= 10;
       if (valor1 = 1) and ((valor2 <> 1) and (valor2 <> 11)) then
         begin
           valor1:= 11;
           bdaz:= true;
         end;
      if (valor2 = 1) and  ((valor1 <> 1) and (valor1 <> 11))  then
          begin
           valor2:= 11;
           bdaz:= true;
          end;
...
button4.Visible:= false;
  if (resj1 > 21) and (bdaz=false) then
      begin
        ganar('La casa ha ganado');
        montomenos;
      end;
 if (resj1 > 21) and bdaz then
   begin
     resj1:= resj1-10;
     label2.Caption:= inttostr(resj1);
     bdaz:= false;
