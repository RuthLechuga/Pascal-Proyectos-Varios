...
Combobox4.Text:= 'Elija una Opción';
end;
...
Edit73.Text:= Floattostr (e * 277777.78) + '  µm/s';
  End;
   1: Begin
...
Combobox5.Text:= 'Elija una Opción';
end;
...
Edit52.Text:= Floattostr (f * 1000000000) + '  µg';
...
Combobox6.Text:= 'Elija una Opción';
end;
...
Edit76.text:= Floattostr (g * 0.1) + '  gravedad estándar';
...
Combobox7.Text:= 'Elija una Opción';
end;
...
Edit80.Text:= Floattostr (h * 1000000) + '  µN';
...
Combobox8.Text:= 'Elija una Opción';
end;
...
Combobox9.Text:= 'Elija una Opción';
end;
...
Combobox10.Text:= 'Elija una Opción';
end;
...
Case (Combobox11.itemindex) of
    0: Begin
       ...
       Edit116.Text:= Floattostr(k * 0.16) + '  Revolución';
       ...
       Edit120.text:= Floattostr(k* 0.64) + '  Ángulo recto';
       Edit121.Text:= Floattostr(k * 16.67) + '  Gon';
    End;
       1: Begin
       k:= Strtofloat(edit110.text) * 6.28;
       Edit116.Text:= Floattostr(k) + '  Radián';
       Edit117.text:= Floattostr(k * 5.09) + '  Punto';
       Edit118.text:= Floattostr(k * 57.3) + '  Grado sexagesimal';
       Edit119.text:= Floattostr(k * 63.66) + ' Grado centesimal';
       Edit120.text:= Floattostr(k* 0.64) + '  Ángulo recto';
       ...
       End;
          2: Begin
            ...
            Edit116.Text:= Floattostr(k * 0.16) + '  Revolución';
            Edit117.text:= Floattostr(k) + '  Radián';
            Edit118.text:= Floattostr(k * 57.3) + '  Grado sexagesimal';
            Edit119.text:= Floattostr(k * 63.66) + ' Grado centesimal';
            Edit120.text:= Floattostr(k* 0.64) + '  Ángulo recto';
            Edit121.Text:= Floattostr(k * 16.67) + '  Gon';
          End;
             3: Begin
                 ...
                 Edit116.Text:= Floattostr(k * 0.16) + '  Revolución';
                 Edit117.text:= Floattostr(k * 5.09) + '  Punto';
                 Edit118.text:= Floattostr(k) + '  Radián';
                 Edit119.text:= Floattostr(k * 63.66) + ' Grado centesimal';
                 Edit120.text:= Floattostr(k* 0.64) + '  Ángulo recto';
                 Edit121.Text:= Floattostr(k * 16.67) + '  Gon';
             End;
                 4: Begin
                      ...
                      Edit117.text:= Floattostr(k * 5.09) + '  Punto';
                      Edit118.text:= Floattostr(k * 57.3) + '  Grado sexagesimal';
                      Edit119.text:= Floattostr(k) + ' Radián';
                      Edit120.text:= Floattostr(k* 0.64) + '  Ángulo recto';
                      Edit121.Text:= Floattostr(k * 16.67) + '  Gon';
                 End;
                     5: Begin
                       ...
                       Edit118.text:= Floattostr(k * 57.3) + '  Grado sexagesimal';
                       Edit119.text:= Floattostr(k * 63.66) + ' Grado centesimal';
                       Edit120.text:= Floattostr(k) + '  Radián';
                       Edit121.Text:= Floattostr(k * 16.67) + '  Gon';
                     End;
                        6: Begin
                        k:= Strtofloat(edit110.text) * 0.02;
                        ...
                        Edit119.text:= Floattostr(k * 63.66) + ' Grado centesimal';
                        Edit120.text:= Floattostr(k* 0.64) + '  Ángulo recto';
                        Edit121.Text:= Floattostr(k) + '  Radián';
                        End;
    end;
end;
end;
...
Combobox11.Text:= 'Elija una Opción';
...
Edit9.text:= Floattostr ((a*3.28) / 6080) + '  Mi. náutica';
Edit10.text:= Floattostr(a*39.37) + '  in';
Edit11.Text:= Floattostr (a * 9461000000000000) + '  Años luz';
Edit12.Text:= Floattostr (a * 1000000) + '  µm';
end;
   1:Begin
...
Combobox1.Text:= 'Elija una Opción';
end;
...
Edit57.Text:= Floattostr (b * 1000000000000) + '  µm²';
...
Combobox2.Text:= 'Elija una Opción';
end;
...
Edit66.Text:= Floattostr (c * 1000000) + '  µl';
end;
   1: Begin
...
Combobox3.Text:= 'Elija una Opción';
end;
...
Edit26.text:= Floattostr (d / 24) + '  día';
Edit27.Text:= Floattostr (d / 8760) + '  año';
Edit67.Text:= Floattostr (d * 3600000) + '  ms';
Edit68.Text:= Floattostr (d * 3600000000) + '  µs';
